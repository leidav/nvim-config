...
require('auto-session').setup({
      ...
      auto_session_suppress_dirs = {'~/', '~/projects','~/Documents/projects'}
})
...
-- split and search
nnoremap('<Leader>s',[[<C-W>s<C-W>j<Cmd>lua require('telescope.builtin').find_files()<CR>]])
nnoremap('<Leader>v',[[<C-W>v<C-W>l<Cmd>lua require('telescope.builtin').find_files()<CR>]])
